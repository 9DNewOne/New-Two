 ...
 * 已上传
 */
public class MyUpedProductionFragment extends Fragment {


    Unbinder unbinder;
    @BindView(R.id.my_uped_production_rv)
    RecyclerView myUpedProductionRv;

    public MyUpedProductionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.my_upedproduction_layout, container, false);
        unbinder = ButterKnife.bind(this, view);
        GridLayoutManager manager = new GridLayoutManager(getActivity(), 3);
        myUpedProductionRv.setLayoutManager(manager);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        myUpedProductionRv.setAdapter(adapter);
    }
